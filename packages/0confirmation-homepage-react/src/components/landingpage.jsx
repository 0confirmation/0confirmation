											...
											>
												...
												>
													...
													<div className="d-flex flex-column flex-wrap thirds px-md">
														...
														<p className="card-sub-text small-margin">
															DEX trading directly with BTC. Trade at the price you see
															NOW not in an hour.
														</p>
														<button
													...
													<div className="d-flex flex-column flex-wrap thirds px-md">
														...
														<p className="card-sub-text small-margin">
															Add liquidity to the 0cf pool. earn income from confirmation
															as a service fees
														</p>
														<button
															className="main-0cf-button"
																	...
																	>
																		<p className="header-text">
																			...
																			<span>
																				...
																				>
																					Total liquidity available in the 0cf
																					renBTC Pool
																				</Tooltip>
																			</span>
																		</p>
																		...
																		<p className="header-text">
																			...
																			<span>
																				...
																				>
																					...
																					used for loans in the 0cf system.
																				</Tooltip>
																			</span>
																		</p>
																	</Col>
