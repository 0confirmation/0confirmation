...
npx source-map-explorer dist/chrome/0cf-inpage.js --html build-artifacts/source-map-explorer/inpage.html
npx source-map-explorer dist/chrome/0cf-contentscript.js --html build-artifacts/source-map-explorer/contentscript.html
